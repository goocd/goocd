...
// Generated by gen-device-svd.go from ATSAME51N19A.svd, see Atmel.SAME51_DFP.1.1.139.atpack

// Microchip ATSAME51N19A Microcontroller
//

package atsame51n19a
...
func HandleInterrupt(num int) {
	...
	case IRQ_SERCOM6_0:
		callHandlers(IRQ_SERCOM6_0)
	case IRQ_SERCOM6_1:
		callHandlers(IRQ_SERCOM6_1)
	case IRQ_SERCOM6_2:
		callHandlers(IRQ_SERCOM6_2)
	case IRQ_SERCOM6_OTHER:
		callHandlers(IRQ_SERCOM6_OTHER)
	case IRQ_SERCOM7_0:
		callHandlers(IRQ_SERCOM7_0)
	case IRQ_SERCOM7_1:
		callHandlers(IRQ_SERCOM7_1)
	case IRQ_SERCOM7_2:
		callHandlers(IRQ_SERCOM7_2)
	case IRQ_SERCOM7_OTHER:
		callHandlers(IRQ_SERCOM7_OTHER)
	case IRQ_CAN0:
...
const (
	...
	// Serial Communication Interface
	SERCOM6_Addr = 0x43000800

	// Serial Communication Interface - I2CM
	SERCOM6_I2CM_Addr = 0x43000800

	// Serial Communication Interface - I2CS
	SERCOM6_I2CS_Addr = 0x43000800

	// Serial Communication Interface - SPIS
	SERCOM6_SPIS_Addr = 0x43000800

	// Serial Communication Interface - SPIM
	SERCOM6_SPIM_Addr = 0x43000800

	// Serial Communication Interface - USART_EXT
	SERCOM6_USART_EXT_Addr = 0x43000800

	// Serial Communication Interface - USART_INT
	SERCOM6_USART_INT_Addr = 0x43000800

	// Serial Communication Interface
	SERCOM7_Addr = 0x43000c00

	// Serial Communication Interface - I2CM
	SERCOM7_I2CM_Addr = 0x43000c00

	// Serial Communication Interface - I2CS
	SERCOM7_I2CS_Addr = 0x43000c00

	// Serial Communication Interface - SPIS
	SERCOM7_SPIS_Addr = 0x43000c00

	// Serial Communication Interface - SPIM
	SERCOM7_SPIM_Addr = 0x43000c00

	// Serial Communication Interface - USART_EXT
	SERCOM7_USART_EXT_Addr = 0x43000c00

	// Serial Communication Interface - USART_INT
	SERCOM7_USART_INT_Addr = 0x43000c00
	...
	// Basic Timer Counter - COUNT8
	TC6_COUNT8_Addr = 0x43001400

	// Basic Timer Counter - COUNT16
	TC6_COUNT16_Addr = 0x43001400

	// Basic Timer Counter - COUNT32
	TC6_COUNT32_Addr = 0x43001400

	// Basic Timer Counter
	TC7_Addr = 0x43001800

	// Basic Timer Counter - COUNT8
	TC7_COUNT8_Addr = 0x43001800

	// Basic Timer Counter - COUNT16
	TC7_COUNT16_Addr = 0x43001800

	// Basic Timer Counter - COUNT32
	TC7_COUNT32_Addr = 0x43001800
